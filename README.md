...
| `tests/` | Governance placeholder tests plus P2-01..P2-05 module tests (config schema, UTC time utility, structured logging / audit events, risk-control interfaces) and the P3-03 `tests/heartbeat/` module exercising `InMemoryHeartbeat` against the abstract `HeartbeatProtocol` |
