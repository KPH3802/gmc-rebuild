...
| `tests/` | Governance placeholder tests plus P2-01..P2-05 module tests (config schema, UTC time utility, structured logging / audit events, risk-control interfaces), the P3-03 `tests/heartbeat/` module exercising `InMemoryHeartbeat` against the abstract `HeartbeatProtocol`, and the P3-04 `tests/kill_switch/` module exercising `InMemoryKillSwitch` against the abstract `KillSwitchProtocol` |
