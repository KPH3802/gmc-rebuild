...
- ADR-009: Runtime Monitoring Cadence and Missed-Packet Severity (ADR-008 §D6 follow-up; **Proposed** — drafted under `governance/authorizations/2026-05-13_p3-01.md`; acceptance is a future, separate authorization)
